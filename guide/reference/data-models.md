...
The shape behind a thread's [`CommentAnnotation.customList`](#commentannotation-thread) — a custom dropdown attached to an annotation via `createCustomListDataOnAnnotation(data)` (see [`apis.md`](./apis.md)).
