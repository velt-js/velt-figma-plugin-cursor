...
| Highcharts comments (integration) | `VeltHighChartComments` *(maps Highcharts points → `VeltChartComment`)* | — |
| Nivo chart comments (integration) | `VeltNivoChartComments` *(maps Nivo points → `VeltChartComment`)* | — |
