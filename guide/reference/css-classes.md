...
Newly verified conditional classes plus corrections to commonly-misremembered names. **Document absences:** three names that are often assumed to be classes are **not** classes in source.
