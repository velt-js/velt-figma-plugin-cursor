...
**Use it when:** any real app where different features need different layers — the normal case. (Run the [decision tree](../02-decision-tree.md) on each feature.)

**Don't use it when:** a single surface genuinely needs only one layer — then just follow that layer's page directly ([css](./css.md) · [wireframes](./wireframes.md) · [primitives](./primitives.md) · [headless](./headless.md)).
...
| Pick the cheapest viable layer per piece via the [decision tree](../02-decision-tree.md) | |
