...
| Render comments onto a **non‑DOM surface** (PDF, canvas, a video timeline) where Velt can't draw | Be the cheap choice — it's the **most expensive** layer; if a [wireframe](./wireframes.md) can express the layout, use it instead |
